...
export const defaultSiteContent: SiteContent = {
  hero: {
    badge: "DÉVELOPPEUR FULLSTACK - IA",
    name: "Cheick Issa",
    subtitle: "Je transforme vos idées en",
    subtitleBold: "solutions digitales intelligentes et automatisées",
    description:
  ...
  about: {
    ...
    paragraphs: {
      intro:
        "Après 3 ans dans le design textile, j'ai découvert ma véritable passion :",
      introBold: "le développement web et l'intelligence artificielle",
      introEnd:
      ...
      training:
        "Formé via deux bootcamps intensifs à GoMyCode Rivera (Abidjan), je combine aujourd'hui compétences techniques fullstack et expertise IA pour concevoir des solutions web modernes, automatisées et intelligentes. De la conception au déploiement, je transforme des processus complexes en interfaces fluides et performantes.",
    },
    statsBoxes: {
      codeYears: "2",
      codeLabel: "ANS CODE",
    ...
    categories: [
      ...
      },
      {
        ...
        skills: [
          ...
          "APIs IA (GPT, Claude, Gemini, Grok)",
          "N8N Workflows",
          "Prompt Engineering",
  ...
  projects: {
    ...
    titleAccent: "Projets",
    subtitle:
      "Une sélection de projets qui démontrent mes compétences en développement web moderne, de la conception à la mise en production.",
    items: [
      {
        id: 1,
        title: "Landkit",
        description:
          "Landing page moderne et responsive avec animations fluides et design premium. Optimisée pour la conversion et le SEO.",
      ...
      },
      {
        ...
        title: "FlowFund",
        description:
          "Plateforme de cagnotte en ligne collaborative et sécurisée. Paiements Stripe, authentification Firebase et dashboard temps réel.",
      ...
      },
      {
        ...
        description:
          "Assistant IA conversationnel intelligent pour e-commerce. Intégration n8n, traitement du langage naturel et réponses contextuelles.",
      ...
      },
      {
        ...
        description:
          "Portfolio développeur moderne avec Next.js 15, animations Framer Motion et design system personnalisé. Optimisé performances et SEO.",
  ...
  contact: {
    ...
    sectionSubtitle:
      "Une question, un projet ou une opportunité ? Je serais ravi d'en discuter avec vous.",
    ...
    form: {
      ...
      successPlaceholderName: "Ex: Cheick Issa San Kara",
      successPlaceholderEmail: "Ex: email@example.com",
      successPlaceholderSubject: "Ex: Demande de collaboration",
      successPlaceholderMessage: "Décrivez votre projet ou votre demande...",
    },
    sidebar: {
      title: "Mes coordonnées",
      emailLabel: "Email",
      emailValue: "admin@san-kara.site",
      linkedinLabel: "LinkedIn",
      linkedinValue: "Voir mon profil",
      githubLabel: "GitHub",
      githubValue: "Voir mes projets",
      locationLabel: "Localisation",
      locationValue: "Abidjan Koumassi, Côte d'Ivoire 🇨🇮",
      whatsappLabel: "WhatsApp",
      whatsappValue: "+225 07 09 55 17 44",
      availabilityLabel: "Disponibilité",
      availabilityValue: "Ouvert aux missions freelance",
    },
  },
};
